...
class FlutterYandexAds {
  ...
  void setOnAdFailedToLoad(String id, String type, Function(AdLoadError) onAdFailedToLoad) {
  ...
  void setOnImpression(String id, String type, Function(String?) callback) {
    api.onImpression(EventRequest(id: id, name: 'onImpression', type: type)).then((value) {
      callback(value.data);
    });
  }

  void setOnRewarded(String id, String type, Function(String?) callback) {
    api.onRewarded(EventRequest(id: id, name: 'onRewarded', type: type)).then((value) {
      callback(value.data);
    });
  }
  ...
  void setOnLeftApplication(String id, String type, Function() callback) {
    api
        .onLeftApplication(EventRequest(id: id, name: 'onLeftApplication', type: type))
        .then((value) {
      callback();
    });
  }
  ...
  void setOnReturnedToApplication(String id, String type, Function() callback) {
    api
        .onReturnedToApplication(EventRequest(id: id, name: 'onReturnedToApplication', type: type))
        .then((value) {
      callback();
    });
  }
