      ...
      } else 
{
  ...
  public interface YandexAdsApi {
    void initialize();
    void onAdLoaded(@NonNull EventRequest request, Result<EventResponse> result);
    void onAdFailedToLoad(@NonNull EventRequest request, Result<EventResponse> result);
    void onImpression(@NonNull EventRequest request, Result<EventResponse> result);
    void onAdClicked(@NonNull EventRequest request, Result<EventResponse> result);
    void onRewarded(@NonNull EventRequest request, Result<EventResponse> result);
    void onLeftApplication(@NonNull EventRequest request, Result<EventResponse> result);
    void onReturnedToApplication(@NonNull EventRequest request, Result<EventResponse> result);
    void onAdShown(@NonNull EventRequest request, Result<EventResponse> result);
    void onAdDismissed(@NonNull EventRequest request, Result<EventResponse> result);
    ...
    static void setup(BinaryMessenger binaryMessenger, YandexAdsApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.YandexAdsApi.onRewarded", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
              ...
              api.onRewarded(requestArg, resultCallback);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
              reply.reply(wrapped);
